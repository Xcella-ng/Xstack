...
class Fuxcel extends FuxcelBase {
	 ...
	 * @return {Promise<Fuxcel>}
	 */
	slideinleft (timeout = 300) {
		const animation = animations({timeout: timeout}).slideInLeft;
		return this.#_animate(animation);
	}
	 ...
	 * @return {Promise<Fuxcel>}
	 */
	slideoutleft (timeout = 300) {
		const animation = animations({timeout: timeout}).slideOutLeft;
		return this.#_animate(animation);
	}
